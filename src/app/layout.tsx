...
export const metadata: Metadata = {
  ...
  openGraph: { type: 'website', siteName: 'PRIYASA', title: 'PRIYASA — Every You, Beautiful', description: 'Contemporary Indian fashion and everyday essentials.', url: siteUrl },
  twitter: { card: 'summary', title: 'PRIYASA — Every You, Beautiful', description: 'Contemporary Indian fashion and everyday essentials.' },
};
